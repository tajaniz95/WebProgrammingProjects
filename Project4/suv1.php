        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-6 tiles">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>AUDI Q7</h3>
                        <p>Fuel Economy:   19 mpg City/25 mpg Hwy</p>
						<p>Dimensions: 200″ L x 78″ W x 69″ H</p>
						<p>Engine: V-6, 3.0L</p>
						<p>The completely redesigned 2017 Audi Q7 scores well in the very competitive luxury midsize SUV class. In particular, its combination of interior quality, passenger and cargo space, and performance stand out. Each of these are important considerations for shoppers in this segment. </p>
                        <p>
					...
					<label>TTL:$</label> <input type="text" id="num1" value="200.98" name="total"><br/>
					<p class="alert_msg" id="alert2">  Please Enter FName</p>
					<label>FN:</label> <input type="text" id="num2"  name="fname"><br/>
					<p class="alert_msg" id="alert3">  Please Enter LName</p>
					<label>LN:</label> <input type="text" id="num3" name="lname"><br/>
					<p class="alert_msg" id="alert4">  Please Enter CCN</p>
					<label>CCN:</label> <input type="text" id="num4" name="cc"><br/>
					<p class="alert_msg" id="alert5">  Please Enter EXP Date</p>
					<label>EXP:</label> <input type="text" id="num5" name="exp"><br/>
					<p class="alert_msg" id="alert6"> <br/></p>
					<label>DAYS:</label> <input type="text" id="num5" name="total2"><br/>
