    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-6 tiles">
                <div class="thumbnail">
                    <img src="images/suv2.jpg" alt="">
                    <div class="caption">
                        <h3>2016 MAZDA 6X9</h3>
                        <p>Fuel Economy: 22 mpg city / 28 mpg highway</p>
                        <p>Dimensions: 199”L</p>
						<p>Engine: V-4, 2.5L</p>
						<p>The 2016 Mazda CX-9 delivers excellent performance for a 3-row SUV and has an upscale interior with a good amount of space.  The 2016 Mazda CX-9 seats seven in three rows. First- and second-row comfort is excellent.</p>
					...
					<label>TTL:$</label> <input type="number" id="num1" value="200.98" name="exp"><br/>
					...
					<label>LN:</label> <input type="text" id="num3" name="mi"><br/>
